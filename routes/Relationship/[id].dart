...
//            Read
//-----------------------------
Future<dynamic> readRelationship(String id, RequestContext context) async{
    try{
      final service = context.read<RelationshipService>();
      
      return service.readAllRelationships(id, context);
    }catch(e){
      throw Exception(e);
    }
}
...
//            Update
//-----------------------------
Future<Response> updateRelationship(String id, RequestContext context)async{
    try{
      final service = context.read<RelationshipService>();

      final data = await context.request.json() as Map<String, dynamic>;

      return service.updateRelationship(id, RelationshipModel.toModel(data));
    }catch(e){
      throw Exception(e);
    }
}
...
//          Delete
//-----------------------------
Future<Response> deleteRelationship(String id, RequestContext context)async{
    try{
      final service = context.read<RelationshipService>();
